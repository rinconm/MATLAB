...
% This script takes a polynomial fraction, either in array or
...
for i=1:10
    % Ask for numerator
    num=input('Enter polynomial of numerator: ');
    fprintf('\n');
    % Ask for denominator
    den=input('Enter polynomial of denominator: ');
    fprintf('\n');
    % Use mypartfrac function
    f=mypartfrac(num, den);
end
% Test
% num=x^5-2*x^4+x^3+x+5
% den=x^3-2*x^2+x-2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Function
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
